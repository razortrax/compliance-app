    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={acknowledgedName.toLowerCase() === staffName.toLowerCase() ? 'border-green-500' : ''}
            />
          ...
          <div className="p-3 bg-gray-50 rounded border text-sm text-gray-600">
            <p><strong>Signature Date/Time:</strong> {new Date().toLocaleString()}</p>
            <p><strong>IP Address:</strong> Will be recorded for audit trail</p>
            <p><strong>CAF ID:</strong> {cafId}</p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="flex justify-end gap-3">
        ...
        <Button
          ...
          disabled={!hasSignature || acknowledgedName.toLowerCase() !== staffName.toLowerCase() || isSubmitting}
