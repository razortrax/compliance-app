  ...
  const fetchABScheduleItems = async () => {
    ...
    try {
      const response = await fetch(
        `/api/equipment/${equipmentId}/ab-schedule?type=${formData.maintenanceType}`,
      );
      if (response.ok) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleInputChange("priority", value as MaintenancePriority)
                }
              >
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleInputChange("maintenanceType", value as MaintenanceType)
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleInputChange("sourceType", value as MaintenanceSourceType)
                }
              >
                <SelectTrigger>
          ...
          {(formData.maintenanceType === "A_SCHEDULE" ||
            formData.maintenanceType === "B_SCHEDULE") && (
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => handleInputChange("status", value as MaintenanceStatus)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => handleInputChange("result", value as MaintenanceResult)}
              >
                <SelectTrigger>
