...
import { FileText, Users, AlertTriangle, Shield, Car, Plus, X, Eye, Upload, MessageSquare } from 'lucide-react'
...
export function EnhancedAccidentForm({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch drivers
        const driversResponse = await fetch(`/api/master/${masterOrgId}/organization/${organizationId}/drivers`)
        ...
        // Fetch equipment
        const equipmentResponse = await fetch(`/api/master/${masterOrgId}/organization/${organizationId}/equipment`)
        if (equipmentResponse.ok) {
          const equipmentData = await equipmentResponse.json()
          const equipment = equipmentData.equipment?.map((eq: any) => ({
            id: eq.id,
  ...
  const addViolation = (violation: any) => {
    const newViolation: Violation = {
      ...
      violationType: violation.type === 'Vehicle' ? 'Equipment' : 
                    violation.type === 'Driver' ? 'Driver_Performance' : 'Company',
      outOfService: violation.severity === 'OUT_OF_SERVICE' || violation.severity === 'Out_Of_Service'
    }
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, officerBadge: e.target.value }))}
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, locationZip: e.target.value }))}
                        placeholder="ZIP"
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, isFatality: !!checked }))}
                        />
                        <Label htmlFor="isFatality" className="text-red-600 font-medium">Fatality</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="isInjury"
                          checked={formData.isInjury}
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, isInjury: !!checked }))}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, isTow: !!checked }))}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, isCitation: !!checked }))}
                        />
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, isReportable: !!checked }))}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, needsReport: !!checked }))}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setFormData(prev => ({ ...prev, needsDrugTest: !!checked }))}
                        />
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData(prev => ({ 
                            ...prev, 
                            numberOfFatalities: e.target.value ? parseInt(e.target.value) : undefined 
                          }))}
                        />
                      </div>
                    )}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={formData.primaryDriverId} onValueChange={(value) => 
                      ...
                      <SelectContent>
                        {filteredDrivers.map((driver) => (
                          <SelectItem key={driver.id} value={driver.id}>
                            {driver.firstName} {driver.lastName} {driver.licenseNumber && `(${driver.licenseNumber})`}
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              ...
                              setFormData(prev => ({
                                ...prev,
                                selectedEquipmentIds: prev.selectedEquipmentIds.filter(id => id !== equipment.id)
                              }))
                            }
                          }}
                        />
                        <Label htmlFor={`equipment-${equipment.id}`} className="flex-1">
                          Unit {equipment.unitNumber} - {equipment.make || 'Unknown'} {equipment.model || ''}
                ...
                <CardContent className="space-y-4">
                  ...
                  {showAddAddon && (
                    <div className="border rounded-lg p-4 bg-gray-50">
                      <div className="space-y-4">
                        <div>
                          <Label>Type</Label>
                          <Select value={newAddon.type} onValueChange={(value) => 
                        ...
                        {newAddon.type === 'note' && (
                          <div>
                            ...
                            <Textarea
                              ...
                              onChange={(e) => setNewAddon(prev => ({ ...prev, content: e.target.value }))}
                        ...
                        {newAddon.type === 'url' && (
                          <div>
                            ...
                            <Input
                              value={newAddon.url || ''}
                              onChange={(e) => setNewAddon(prev => ({ ...prev, url: e.target.value }))}
                              placeholder="https://..."
                            />
                          </div>
                        )}
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button type="button" variant="outline" onClick={() => setShowAddAddon(false)}>
                            Cancel
                          </Button>
                        </div>
                      </div>
                  ...
                  {formData.addons.length === 0 ? (
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm">Add photos, notes, documents, or links related to this accident</p>
                    </div>
                  ) : (
                    <div className="space-y-3">
                      {formData.addons.map((addon, index) => (
                        <div key={index} className="flex justify-between items-start p-3 border rounded-lg">
                          <div className="flex-1">
                            ...
                            {addon.url && (
                              <p className="text-sm text-blue-600 mt-1">{addon.url}</p>
                            )}
                            {addon.description && (
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <Select value={formData.weatherConditions} onValueChange={(value) => 
                    ...
                    <div>
                      ...
                      <Select value={formData.roadConditions} onValueChange={(value) => 
                    ...
                    <div>
                      ...
                      <Select value={formData.trafficConditions} onValueChange={(value) => 
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {formData.needsDrugTest && <Badge variant="outline">Drug Test Required</Badge>}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      <p>Driver: {availableDrivers.find(d => d.id === formData.primaryDriverId)?.firstName} {availableDrivers.find(d => d.id === formData.primaryDriverId)?.lastName}</p>
                      ...
                      <div className="space-y-1">
                        {formData.violations.map((violation, index) => (
                          <div key={index} className="text-sm bg-gray-50 p-2 rounded">
                            <span className="font-medium">{violation.code}</span> - {violation.description}
                          </div>
                        ))}
                      </div>
                    ) : (
