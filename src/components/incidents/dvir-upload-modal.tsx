    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a Driver Vehicle Inspection Report (DVIR) to automatically extract inspection
            data
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            {(["upload", "ocr", "parsing", "validation", "complete"] as ProcessingStage[]).map(
              (stage, index) => (
              ...
              <CardContent className="space-y-4">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-gray-500">PDF, JPG, or PNG files up to 10MB</p>
                  </div>
                </div>
