...
export function EntityDetailPage({ entityType, entityId }: EntityDetailPageProps) {
  ...
  const fetchEntityData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const relatedEndpoint = entityType === 'organization' 
          ? '/api/organizations' 
          : '/api/locations'
  ...
  const handleEntitySelect = (selectedEntity: EntityData) => {
    ...
    const route = entityType === 'organization' 
  ...
  const breadcrumbs = () => {
    if (entityType === 'location' && entity.parentOrganization) {
      return [
        ...
        { label: entity.parentOrganization.name, href: `/organizations/${entity.parentOrganization.id}` },
        { label: entity.name }
      ]
    }
    return [
      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              <SheetTrigger asChild>
                <Button variant="outline" size="default" className="h-10 px-3 border-gray-300 hover:bg-gray-50">
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Select a different {entityType} to manage
                  </SheetDescription>
                </SheetHeader>
                    ...
                    >
                      <div>
                        ...
                        {entityType === 'organization' && relatedEntity.dotNumber && (
                          <div className="text-sm text-gray-500">DOT: {relatedEntity.dotNumber}</div>
                        )}
                        {entityType === 'location' && (
                          <div className="text-sm text-gray-500 capitalize">{relatedEntity.locationType}</div>
                        )}
                      </div>
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="w-full justify-start">
            ...
            {entityType === 'organization' && <TabsTrigger value="locations">Locations</TabsTrigger>}
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label>{entityType === 'organization' ? 'Organization' : 'Location'} Name</Label>
                    {isEditing ? (
                      <Input
                      ...
                      <div className="space-y-2">
                        ...
                        {isEditing ? (
                          <Input
                            ...
                            onChange={(e) => setEditedEntity(prev => prev ? {...prev, dotNumber: e.target.value} : null)}
                          />
                        ) : (
                          <p className="text-gray-900">
                            {entity.dotNumber === 'NO_DOT' ? 'No DOT Number' : entity.dotNumber || 'Not provided'}
                          </p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {isEditing ? (
                          <Input
                            ...
                            onChange={(e) => setEditedEntity(prev => prev ? {...prev, einNumber: e.target.value} : null)}
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      <Input
                        ...
                        onChange={(e) => setEditedEntity(prev => prev ? {...prev, phone: e.target.value} : null)}
                      />
                    ) : (
                    ...
                    <div className="space-y-2">
                      ...
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) => setEditedEntity(prev => prev ? {...prev, email: e.target.value} : null)}
                        />
                      ) : (
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    {isEditing ? (
                      <Textarea
                        ...
                        onChange={(e) => setEditedEntity(prev => prev ? {...prev, address: e.target.value} : null)}
                        rows={2}
                      />
                    ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      <Input
                        ...
                        onChange={(e) => setEditedEntity(prev => prev ? {...prev, city: e.target.value} : null)}
                      />
                    ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      <Input
                        ...
                        onChange={(e) => setEditedEntity(prev => prev ? {...prev, state: e.target.value} : null)}
                      />
                    ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      <Input
                        ...
                        onChange={(e) => setEditedEntity(prev => prev ? {...prev, zipCode: e.target.value} : null)}
                      />
                    ) : (
