...
export function TrainingForm({
  ...
  const [formData, setFormData] = useState({
    ...
    startDate: baseTraining?.startDate
      ? new Date(baseTraining.startDate)
      : (undefined as Date | undefined),
    completionDate: baseTraining?.completionDate
      ? new Date(baseTraining.completionDate)
      : initialDates.completionDate,
    expirationDate: baseTraining?.expirationDate
      ? new Date(baseTraining.expirationDate)
      : (undefined as Date | undefined),
  ...
  useEffect(() => {
    ...
    formData.category,
    formData.trainingType,
    formData.expirationPeriodMonths,
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {isRenewal
              ? "Renew existing training record"
              : isEditing
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      expirationPeriodMonths: parseInt(e.target.value) || null,
                    })
                  }
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Set training completion and expiration dates</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={
                  formData.completionDate
                    ? format(new Date(formData.completionDate), "yyyy-MM-dd")
                    : ""
                }
                onChange={(e) => {
            ...
            {(formData.category === "MANDATORY_DOT" ||
              formData.category === "MANDATORY_ORG" ||
              formData.hasExpiration) && (
              <div className="space-y-2">
                <Label>
                  ...
                  {formData.category === "MANDATORY_DOT" &&
                    formData.trainingType.toLowerCase().includes("hazmat") && (
                      <Badge variant="secondary" className="ml-2 text-xs">
                        Auto: 2 years
                      </Badge>
                    )}
            ...
            <div className="flex flex-wrap gap-2">
              {competencies.map((competency, index) => (
                <Badge key={index} variant="secondary" className="flex items-center gap-1">
                  {competency}
                  <X className="h-3 w-3 cursor-pointer" onClick={() => removeCompetency(index)} />
                </Badge>
              ))}
            </div>
          )}
