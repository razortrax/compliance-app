...
export function LicenseForm({
  ...
  const addEndorsement = () => {
    ...
    const newEndorsement: Endorsement = {
      ...
      expirationDate:
        endorsementData.requiresExpiration && endorsementExpiration
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            {selectedEndorsement &&
              AVAILABLE_ENDORSEMENTS.find((e) => e.code === selectedEndorsement)
                ?.requiresExpiration && (
                <Popover
                  open={isEndorsementExpirationOpen}
                  onOpenChange={setIsEndorsementExpirationOpen}
                >
                  <PopoverTrigger asChild>
