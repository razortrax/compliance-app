...
export default function MasterDriverOverviewPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        `/api/master/${masterOrgId}/organization/${orgId}/driver/${driverId}`,
      );
  ...
  const topNav = buildStandardDriverNavigation(masterOrgId, orgId, driverId, userRole || undefined);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500">
              {data.driver.licenseNumber && <span>License: {data.driver.licenseNumber}</span>}
              {data.driver.phone && <span>Phone: {data.driver.phone}</span>}
              {data.driver.email && <span>Email: {data.driver.email}</span>}
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link href={`/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/licenses`}>
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">Click to view all licenses</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/mvr-issue`}>
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">Click to view all MVRs</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href={`/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/training`}>
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-2">Click to view all training</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Card className="opacity-50">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">Physical exams tracking</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Common tasks for this driver</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <Link
                href={`/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/licenses`}
              >
              ...
              <Link
                href={`/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/mvr-issue`}
              >
                <Button variant="outline" className="w-full justify-start">
              ...
              <Link
                href={`/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/training`}
              >
                <Button variant="outline" className="w-full justify-start">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {data.compliance.licenses.total} total records
                    </p>
                  </div>
                </div>
                {getComplianceBadge(
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {data.compliance.mvrs.total} total records
                    </p>
                  </div>
                </div>
                {getComplianceBadge(
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {data.compliance.training.total} total • {data.compliance.training.required}{" "}
                      DOT required
                    </p>
                  </div>
                </div>
