...
export default function DriverAccidentsPage({
  ...
  const handleOrganizationSelect = (org: any) => {
    // Changed to any as Organization type is removed
  ...
  if (!data) {
    return (
      <AppLayout name="Error" topNav={[]} className="p-6">
        <div className="flex items-center justify-center h-64">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500">
              ...
              <span>•</span>
              <span>
                Violations: {data.accidents.reduce((acc, a) => acc + a.violations.length, 0)}
              </span>
            </div>
          </div>
          ...
          <div className="w-[300px] flex-shrink-0">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>Motor vehicle accident records</CardDescription>
              </CardHeader>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => setSelectedAccident(null)}>
                          ✕
                        </Button>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedAccident.isFatality && (
                          <Badge variant="destructive">
                            Fatality{" "}
                            {selectedAccident.numberOfFatalities &&
                              `(${selectedAccident.numberOfFatalities})`}
                          </Badge>
                        )}
                        {selectedAccident.isInjury && <Badge variant="secondary">Injury</Badge>}
                        {selectedAccident.isReportable && (
                        ...
                        {selectedAccident.isCitation && (
                          <Badge variant="outline">Citations Issued</Badge>
                        )}
                        {selectedAccident.needsReport && (
                          <Badge variant="outline">Needs Report</Badge>
                        )}
                        {selectedAccident.needsDrugTest && (
