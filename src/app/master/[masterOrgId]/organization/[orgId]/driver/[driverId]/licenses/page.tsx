  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        `/api/master/${masterOrgId}/organization/${orgId}/driver/${driverId}/licenses`,
      );
          ...
          <div className="w-[300px] flex-shrink-0">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>License records for this driver</CardDescription>
              </CardHeader>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        {selectedLicense.startDate && (
                          <div>
                            ...
                            <span className="ml-2">
                              {format(new Date(selectedLicense.startDate), "MMM dd, yyyy")}
                            </span>
                          </div>
                        )}
                        {selectedLicense.expirationDate && (
                          <div>
                            ...
                            <span className="ml-2">
                              {format(new Date(selectedLicense.expirationDate), "MMM dd, yyyy")}
                            </span>
                          </div>
                        )}
                        {selectedLicense.renewalDate && (
                          <div>
                            ...
                            <span className="ml-2">
                              {format(new Date(selectedLicense.renewalDate), "MMM dd, yyyy")}
                            </span>
                          </div>
                        )}
                      </div>
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">
                        Select a license record
                      </h3>
                      <p className="text-gray-600">
                        Choose a license from the list to view its details
                      </p>
                    </div>
                  </div>
                )}
