...
interface MaintenanceIssue {
  ...
  laborHours?: number
  cost?: number
  status: 'SCHEDULED' | 'OVERDUE' | 'IN_PROGRESS' | 'COMPLETED' | 'PARTIAL' | 'DEFERRED' | 'CANCELLED' | 'ON_HOLD'
      ...
      <div className="flex flex-col h-full max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6 flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            <Button
              variant="outline"
              onClick={() => handleGenerateABSchedule()}
            >
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-gray-600">
                                {issue.maintenanceType.replace('_', ' ')} • {issue.sourceType.replace('_', ' ')}
                              </div>
                              {issue.dueDate && (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      {selectedIssue.laborHours && (
                        <div>
                          ...
                          <div className="mt-1 text-sm">
                            {selectedIssue.laborHours} hours
                          </div>
                        </div>
                      )}
                    </div>
