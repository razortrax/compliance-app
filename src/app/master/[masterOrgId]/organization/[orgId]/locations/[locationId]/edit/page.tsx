  ...
  return (
    <div className="flex flex-col">
      ...
      <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-4">
        <a href="/dashboard" className="hover:text-gray-900">Organizations</a>
        <span className="text-gray-400">/</span>
        <a href={`/organizations/${params.id}`} className="hover:text-gray-900">
          {organization?.name || 'Organization'}
        </a>
        <span className="text-gray-400">/</span>
        <a href={`/organizations/${params.id}/locations/${params.locationId}`} className="hover:text-gray-900">
          {location.name}
        </a>
        <span className="text-gray-400">/</span>
