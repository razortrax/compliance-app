                  ...
                  {trainings.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">
                        Add training records and certifications for {driver.firstName}{" "}
                        {driver.lastName}
                      </p>
                      <Button
                        onClick={() => {
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Renewing {selectedTraining?.trainingType} for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Create a new training record for {driver.firstName} {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                          variant="outline"
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Edit details for {selectedTraining?.trainingType} for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                  ...
                  <>
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button size="sm" onClick={() => handleRenewTraining(selectedTraining)}>
                            Renew Training
                          </Button>
                        </div>
                      </div>
                    ...
                    <CardContent className="overflow-y-auto max-h-[calc(100%-120px)]">
                      <div className="space-y-6">
                        ...
                        {/* Competencies */}
                        {selectedTraining.competencies &&
                          selectedTraining.competencies.length > 0 && (
                            <div>
                              <h4 className="font-medium text-gray-900 mb-3">
                                Competencies Covered
                              </h4>
                              <div className="flex flex-wrap gap-2">
                                {selectedTraining.competencies.map(
                          ...
                          <div className="space-y-2">
                            ...
                            {attachments.length === 0 && (
                              <div className="text-center py-6 text-gray-500">
                                ...
                                <p className="text-xs">
                                  Add notes, certificates, or other files related to this training
                                </p>
                              </div>
                            )}
                          </div>
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600">
                        Choose a training from the list to view details
                      </p>
                    </div>
                  </div>
                )}
