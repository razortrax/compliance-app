...
export default function DriverLicensesPage() {
  ...
  const getExpirationStatus = (license: License) => {
    ...
    const hasNewerLicense = licenses.some(
      (otherLicense) =>
                  ...
                  {licenses.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">
                        Add licenses and certifications for {driver.firstName} {driver.lastName}
                      </p>
                      <Button
                        onClick={() => {
                          setSelectedLicense(null);
                      ...
                      {[...licenses]
                        ...
                        .map((license) => {
                          ...
                          const getEndorsementExpiry = (endorsements: any[]) => {
                            const hazmatEndorsement = endorsements.find(
                              (e) => e.code === "H" && e.expirationDate,
                            );
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    <h4 className="font-medium text-gray-900 text-sm">
                                      {license.licenseType} - {license.licenseState} #
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  {endorsementExpiry && (
                                    <Badge
                                      variant={
                                        endorsementExpiry.expired ? "destructive" : "secondary"
                                      }
                                      className="text-xs"
                                    >
                                      {endorsementExpiry.type}{" "}
                                      {endorsementExpiry.expired
                                        ? "Exp"
                                        : `${endorsementExpiry.daysUntil}d`}
                                    </Badge>
                                  )}
                                </div>
                              </div>
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Renewing {selectedLicense?.issue.title} for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Create a new license for {driver.firstName} {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                          variant="outline"
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Edit details for {selectedLicense?.issue.title} for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              {selectedLicense.endorsements?.length > 0 && (
                                <div>
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {selectedLicense.endorsements.map(
                                      (endorsement: any, idx: number) => (
                              ...
                              {selectedLicense.restrictions?.length > 0 && (
                                <div>
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {selectedLicense.restrictions.map(
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              {(() => {
                                const frontPhoto = attachments.find(
                                  (a) => a.attachmentType === "license_front",
                                );
                            ...
                            <div>
                              ...
                              {(() => {
                                const backPhoto = attachments.find(
                                  (a) => a.attachmentType === "license_back",
                                );
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            {attachments
                              .filter(
                                (a) =>
                                  !["license_front", "license_back"].includes(a.attachmentType),
                              )
                              .map((addon) => (
                                <div
                                  key={addon.id}
                            ...
                            {attachments.filter(
                              (a) => !["license_front", "license_back"].includes(a.attachmentType),
                            ).length === 0 && (
                              <div className="text-center py-6 text-gray-500">
                                <FileText className="h-8 w-8 mx-auto mb-2 text-gray-300" />
                                <p className="text-sm">No addons yet</p>
                                <p className="text-xs">
                                  Add notes, documents, or other files related to this license
                                </p>
                              </div>
                            )}
                          </div>
                  ...
                  <CardContent className="flex items-center justify-center h-full text-center">
                    <div>
                      ...
                      <p className="text-gray-600">
                        Choose a license from the list to view details
                      </p>
                    </div>
                  </CardContent>
                )}
