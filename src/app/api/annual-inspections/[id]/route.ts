...
export async function PUT(
  ...
  try {
    ...
    const result = await db.$transaction(async (tx) => {
      ...
      if (body.inspectionDate !== undefined) inspectionUpdates.inspectionDate = new Date(body.inspectionDate)
      if (body.expirationDate !== undefined) inspectionUpdates.expirationDate = new Date(body.expirationDate)
