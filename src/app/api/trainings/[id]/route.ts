  ...
  try {
    ...
    const result = await db.$transaction(async (tx) => {
      ...
      if (body.startDate !== undefined)
        trainingUpdateData.startDate = body.startDate ? new Date(body.startDate) : null;
      if (body.completionDate !== undefined)
        trainingUpdateData.completionDate = new Date(body.completionDate);
      if (body.expirationDate !== undefined)
        trainingUpdateData.expirationDate = new Date(body.expirationDate);
      if (body.certificateNumber !== undefined)
        trainingUpdateData.certificateNumber = body.certificateNumber;
      ...
      if (body.competencies !== undefined)
        trainingUpdateData.competencies = body.competencies as any;
