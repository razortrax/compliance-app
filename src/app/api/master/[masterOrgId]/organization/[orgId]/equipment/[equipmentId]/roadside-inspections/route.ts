...
export const GET = withApiError(
  ...
  async (
    ...
    try {
      ...
      console.log(
        "🔍 Equipment RSIN Debug - RSIN equipment links:",
        allRSINs.map((r) => ({
          incidentId: r.id,
          partyId: r.issue.partyId,
          equipmentInvolvement: r.equipment.map((e) => ({
      ...
      console.log(
        "🔍 Equipment RSIN Debug - Equipment involvements for this equipment:",
        equipmentInvolvements,
      );
          ...
          issue: {
            ...
            party: {
              ...
              equipment: inspection.issue.party.equipment
                ? {
                    vehicleTypeId: inspection.issue.party.equipment.vehicleTypeId,
                    ...
                    vin: inspection.issue.party.equipment.vin,
          ...
          await db.incident_violation.create({
            data: {
              ...
              outOfServiceDate: violation.outOfServiceDate
                ? new Date(violation.outOfServiceDate)
                : null,
              backInServiceDate: violation.backInServiceDate
                ? new Date(violation.backInServiceDate)
                : null,
              citationNumber: violation.citationNumber,
              severity: violation.severity,
              description: violation.description,
