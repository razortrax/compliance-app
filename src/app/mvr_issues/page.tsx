        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              No driver selected. Please select a driver to view their MVR records.
            </p>
          </div>
        </div>
      </AppLayout>
                  ...
                  {mvrIssues.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">
                        Add MVR records for {driver.firstName} {driver.lastName}
                      </p>
                      <Button
                        onClick={() => {
                          setSelectedMvr(null);
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="text-xs text-gray-600">
                                    {(mvr.type && MVR_TYPE_LABELS[mvr.type]) || mvr.type || "MVR"} •{" "}
                                    {mvr.state}
                                  </div>
                                  <Badge
                                    variant={
                                ...
                                <div className="flex items-center justify-between text-xs text-gray-500">
                                  ...
                                  {mvr.result && <span className="font-medium">{mvr.result}</span>}
                                </div>
                              </div>
                            </div>
                          );
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Create a new Motor Vehicle Record for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Edit details for {selectedMvr?.issue.title} for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <CardDescription>
                            Renew {selectedMvr?.issue.title} for {driver.firstName}{" "}
                            {driver.lastName}
                          </CardDescription>
                        </div>
                        <Button
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <span className="ml-2">
                                {(selectedMvr.type && MVR_TYPE_LABELS[selectedMvr.type]) ||
                                  selectedMvr.type ||
                                  "N/A"}
                              </span>
                            </div>
                            ...
                            <div>
                              ...
                              <span className="ml-2">
                                {(selectedMvr.status && MVR_STATUS_LABELS[selectedMvr.status]) ||
                                  selectedMvr.status ||
                                  "N/A"}
                              </span>
                            </div>
