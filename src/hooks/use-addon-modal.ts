...
export const ADDON_CONFIGURATIONS = {
  ...
  license: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add a note about this license' },
      { value: 'attachment', label: 'Document', icon: Paperclip, description: 'Upload license document or scan' }
    ] as AddonType[],
  ...
  training: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add training notes or comments' },
      { value: 'attachment', label: 'Certificate', icon: Paperclip, description: 'Upload training certificate or completion document' }
    ] as AddonType[],
  ...
  mvr: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add notes about this MVR report' },
      { value: 'attachment', label: 'Report Document', icon: Paperclip, description: 'Upload MVR report or related documents' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  drugalcohol: {
    availableTypes: [
      ...
      { value: 'attachment', label: 'Test Results', icon: Paperclip, description: 'Upload test results or related documents' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  physical: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add notes about this physical exam' },
      { value: 'attachment', label: 'Medical Certificate', icon: Paperclip, description: 'Upload DOT medical certificate or exam documents' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  accident: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add notes about this accident' },
      { value: 'attachment', label: 'Report/Photo', icon: Paperclip, description: 'Upload accident reports, photos, or documentation' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  roadside_inspection: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add notes about this inspection' },
      { value: 'attachment', label: 'Inspection Report', icon: Paperclip, description: 'Upload inspection report or related documents' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  registration: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add notes about this registration' },
      { value: 'attachment', label: 'Registration Document', icon: Paperclip, description: 'Upload registration documents or renewals' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  maintenance: {
    availableTypes: [
      { value: 'note', label: 'Note', icon: FileText, description: 'Add maintenance notes or instructions' },
      { value: 'attachment', label: 'Work Order/Receipt', icon: Paperclip, description: 'Upload work orders, receipts, or photos' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
  ...
  organization: {
    availableTypes: [
      ...
      { value: 'attachment', label: 'Document', icon: Paperclip, description: 'Upload files and documents' },
      { value: 'url', label: 'External System', icon: Link, description: 'Link to external systems with login credentials' }
    ] as AddonType[],
    allowFileUpload: false, // Until DigitalOcean Spaces
  ...
  generic: {
    availableTypes: [
      ...
      { value: 'attachment', label: 'Document', icon: Paperclip, description: 'Upload a document or file' }
    ] as AddonType[],
    allowFileUpload: false,
    allowUrlWithCredentials: false,
    defaultType: 'note',
