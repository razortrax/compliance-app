...
import { FileText, Paperclip, Calendar, ClipboardList, Receipt, UserCheck, Camera, AlertTriangle, Shield, MessageSquare } from 'lucide-react'
  ...
  mvr: {
    modal: {
      availableTypes: [
        ...
        { value: 'attachment', label: 'Attachment', icon: Paperclip, description: 'Upload supporting documents' },
        { value: 'todo', label: 'ToDo', icon: ClipboardList, description: 'Create assigned task (shows on user dashboard)' },
        { value: 'communication', label: 'Communication', icon: MessageSquare, description: 'Log communications (future: auto-draft email/text)' },
        // MVR specific
        { value: 'report', label: 'MVR Report', icon: Paperclip, description: 'Upload MVR report document' }
      ] as AddonType[],
  ...
  physical: {
    modal: {
      availableTypes: [
        ...
        { value: 'communication', label: 'Communication', icon: MessageSquare, description: 'Log communications (future: auto-draft email/text)' },
        // Physical specific
        { value: 'schedule', label: 'Schedule', icon: Calendar, description: 'Schedule appointment date and time' },
        { value: 'report', label: 'Physical Report', icon: Paperclip, description: 'Upload physical examination report' }
      ] as AddonType[],
  ...
  license: {
    modal: {
      availableTypes: [
        ...
        { value: 'communication', label: 'Communication', icon: MessageSquare, description: 'Log communications (future: auto-draft email/text)' },
        // License specific
        { value: 'license_front', label: 'Front Photo', icon: Camera, description: 'Upload front of license' },
        { value: 'license_back', label: 'Back Photo', icon: Camera, description: 'Upload back of license' },
        { value: 'endorsement', label: 'Endorsement', icon: Paperclip, description: 'Upload endorsement documentation' }
      ] as AddonType[],
  ...
  annual_inspection: {
    modal: {
      availableTypes: [
        ...
        { value: 'schedule', label: 'Schedule', icon: Calendar, description: 'Schedule inspection date and time' },
        { value: 'report', label: 'Inspection Report', icon: Paperclip, description: 'Upload annual inspection report' }
      ] as AddonType[],
  ...
  training: {
    modal: {
      availableTypes: [
        ...
        { value: 'communication', label: 'Communication', icon: MessageSquare, description: 'Log communications (future: auto-draft email/text)' },
        // Training specific
        { value: 'schedule', label: 'Schedule', icon: Calendar, description: 'Schedule training date and time' },
        { value: 'certificate', label: 'Certificate', icon: Paperclip, description: 'Upload training certificate' }
      ] as AddonType[],
  ...
  maintenance: {
    modal: {
      availableTypes: [
        ...
        { value: 'schedule', label: 'Schedule', icon: Calendar, description: 'Schedule maintenance date and time' },
        { value: 'work_order', label: 'Work Order', icon: ClipboardList, description: 'Create or upload work order' },
        { value: 'receipt', label: 'Receipt', icon: Receipt, description: 'Upload repair/maintenance receipt' }
      ] as AddonType[],
  ...
  roadside_inspection: {
    modal: {
      availableTypes: [
        ...
        { value: 'communication', label: 'Communication', icon: MessageSquare, description: 'Log communications (future: auto-draft email/text)' },
        // RSIN specific
        { value: 'dvir_report', label: 'DVIR Report', icon: Paperclip, description: 'Upload DVIR report' },
        { value: 'caf_original', label: 'CAF - Original', icon: ClipboardList, description: 'Original CAF document' },
        { value: 'caf_returned', label: 'CAF - Returned', icon: UserCheck, description: 'Returned signed CAF' }
      ] as AddonType[],
  ...
  accident: {
    modal: {
      availableTypes: [
        ...
        { value: 'communication', label: 'Communication', icon: MessageSquare, description: 'Log communications (future: auto-draft email/text)' },
        // Accident specific
        { value: 'police_report', label: 'Police Report', icon: Shield, description: 'Upload police report' },
        { value: 'caf_original', label: 'CAF - Original', icon: ClipboardList, description: 'Original CAF document' },
        { value: 'caf_returned', label: 'CAF - Returned', icon: UserCheck, description: 'Returned signed CAF' },
        { value: 'accident_photo', label: 'Accident Photo', icon: Camera, description: 'Upload accident scene photos' }
      ] as AddonType[],
...
export function useUnifiedAddons({
  ...
  return {
    ...
    modalTitle: editingAddon ? `Edit ${modalConfig.modalTitle.replace('Add ', '')}` : modalConfig.modalTitle
  }
}
